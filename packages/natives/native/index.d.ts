...
export declare class AppServer {
   ...
   */
  constructor(onFrame: (err: null | Error, frame: string) => void, onCall: (err: null | Error, call: string) => void, maxInflightTurnsPerThread?: number)
   ...
   */
  resolveCall(callId: string, ok: boolean, json: string): void
  /**
 ...
 */
export declare function __piNativesV0_9_5(): void
 ...
 * `"cancel"`, or `"read"`).
 */
export declare function appServerMethodLane(method: string): string
